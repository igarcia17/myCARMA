...
Cauchy_marginal <- function(index_vec_input, Sigma, z, zSigmaz, tau, p, p_S) {
    .Call(`_myCARMA_Cauchy_marginal`, index_vec_input, Sigma, z, zSigmaz, tau, p, p_S)
}
...
Cauchy_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_Cauchy_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
hyper_g_marginal <- function(index_vec_input, Sigma, z, zSigmaz, p, tau, p_S) {
    .Call(`_myCARMA_hyper_g_marginal`, index_vec_input, Sigma, z, zSigmaz, p, tau, p_S)
}
...
hyper_g_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_hyper_g_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
ind_Normal_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_ind_Normal_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
Normal_marginal <- function(index_vec_input, Sigma, z, zSigmaz, tau, p, p_S) {
    .Call(`_myCARMA_Normal_marginal`, index_vec_input, Sigma, z, zSigmaz, tau, p, p_S)
}
...
Normal_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_Normal_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
outlier_Cauchy_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_outlier_Cauchy_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
outlier_ind_Normal_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_outlier_ind_Normal_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
...
outlier_Normal_fixed_sigma_marginal <- function(index_vec_input, Sigma, z, tau, p_S, y_sigma) {
    .Call(`_myCARMA_outlier_Normal_fixed_sigma_marginal`, index_vec_input, Sigma, z, tau, p_S, y_sigma)
}
